  ...
  <div class="hello">
    ...
    <div class="UserInfo">
      ...
      <ul>
        <li v-for="(item, index) in participants" v-bind:key="index">
          ...
          <span
            v-if="!item.isHost && currentUser !== null && currentUser.isHost"
            ><button @click="makeHost(item.userId)">호스트교체</button></span
          >
    ...
    <div class="VideoCanvas">
      ...
      <div v-if="this.stream !== null">
        ...
        <button
          v-if="currentUser !== null && currentUser.isHost"
          @click="endSession()"
        >
          End Session
        </button>
